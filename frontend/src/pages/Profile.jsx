        ...
        <section className="profile-page">
          ...
          <div className="profile-layout">
            ...
            <div className="profile-main">
              ...
              <section
                className={`profile-card ${collapsed.personal ? "collapsed" : ""}`}
              >
              ...
              {!isNGO && (
                <section
                  className={`profile-card ${collapsed.preferences ? "collapsed" : ""}`}
                >
                  <header className="profile-card-header">
                    <div>
                      <h2>Preferences</h2>
                      ...
                      <div className="profile-preferences-grid">
                        <div className="profile-checkbox-group">
                          ...
                          <label className="profile-checkbox-label">
                            <input
                              type="checkbox"
                              checked={preferences.ngoUpdates}
                              onChange={(e) =>
                                setPreferences({
                                  ...preferences,
              ...
              {/* Security */}
              <section
                className={`profile-card ${collapsed.security ? "collapsed" : ""}`}
              >
                <header className="profile-card-header">
                  <div>
                    <h2>Security</h2>
              ...
              {isNGO && (
                <section
                  className={`profile-card ${collapsed.organization ? "collapsed" : ""}`}
                >
                  <header className="profile-card-header">
                    <div>
                    ...
                    <button
                      type="button"
                      className="profile-link-button"
                      onClick={() => toggleCard("organization")}
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          <textarea
                            ...
                            value={ngoInfo.story}
                            onChange={(e) =>
                              setNgoInfo({ ...ngoInfo, story: e.target.value })
                            }
                          />
                        </div>
                        <div
              ...
              {!isNGO && (
                <section
                  className={`profile-card ${collapsed.payment ? "collapsed" : ""}`}
                >
                  <header className="profile-card-header">
                    <div>
                      ...
                      <div className="profile-payment-content">
                        <div className="profile-payment-section">
                          <div style={paymentHeaderStyle}>
                            ...
                            <button
                              type="button"
                              className="profile-payment-add-button"
                            ...
                            {paymentMethods.length > 0 ? (
                              paymentMethods.map((pm, idx) => (
                                ...
                                >
                                  <span>
                                    {pm.type} (
                                    {pm.identifier.length > 4
                                      ? `**** ${pm.identifier.slice(-4)}`
                                      : pm.identifier}
                                    )
                                  </span>
                                  {pm.isDefault && (
